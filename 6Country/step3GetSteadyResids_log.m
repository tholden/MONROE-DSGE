...
%  5.add any parameters that are equations of other parameters
	...
	LW5l_ =      LW1l_      /Ntilde1_*Ntilde5_;
    LT5l_ =      LT1l_      /Ntilde1_*Ntilde5_;

    LSW5l_ =     LSW1l_     /Ntilde1_*Ntilde5_;
    LST5l_ =     LST1l_     /Ntilde1_*Ntilde5_;

    LNDCG5l_ =   LNDCG1l_   /Ntilde1_*Ntilde5_;

    CD5l_ =      CD1l_      /Ntilde1_*Ntilde5_;
    CND5l_ =     CND1l_     /Ntilde1_*Ntilde5_;



    CND5b_ =     CND1b_     /Ntilde1_*Ntilde5_;
	LKP5_ =      LKP1_      /Ntilde1_*Ntilde5_;
	LHP5_ =      LHP1_      /Ntilde1_*Ntilde5_;
	LND5_ =      LND1_      /Ntilde1_*Ntilde5_;
	LCG5_ =      LCG1_      /Ntilde1_*Ntilde5_;
	LKG5_ =      LKG1_      /Ntilde1_*Ntilde5_;
	LHG5_ =      LHG1_      /Ntilde1_*Ntilde5_;
	KPT5_ =      KPT1_      /Ntilde1_*Ntilde5_;

	KPW5_ =      KPW1_      /Ntilde1_*Ntilde5_;
	IKP5_ =      IKP1_      /Ntilde1_*Ntilde5_;
    IHP5_ =      IHP1_      /Ntilde1_*Ntilde5_;
    P5_ =        P1_        ;
	YWC5_ =      YWC1_      /Ntilde1_*Ntilde5_;
	X5_ =        X1_        /Ntilde1_*Ntilde5_;
	LW6l_ =      LW1l_      /Ntilde1_*Ntilde6_;
    LT6l_ =      LT1l_      /Ntilde1_*Ntilde6_;

    LSW6l_ =     LSW1l_     /Ntilde1_*Ntilde6_;
    LST6l_ =     LST1l_     /Ntilde1_*Ntilde6_;

    LNDCG6l_ =   LNDCG1l_   /Ntilde1_*Ntilde6_;

    CD6l_ =      CD1l_      /Ntilde1_*Ntilde6_;
    CND6l_ =     CND1l_     /Ntilde1_*Ntilde6_;



    CND6b_ =     CND1b_     /Ntilde1_*Ntilde6_;
	LKP6_ =      LKP1_      /Ntilde1_*Ntilde6_;
	LHP6_ =      LHP1_      /Ntilde1_*Ntilde6_;
	LND6_ =      LND1_      /Ntilde1_*Ntilde6_;
	LCG6_ =      LCG1_      /Ntilde1_*Ntilde6_;
	LKG6_ =      LKG1_      /Ntilde1_*Ntilde6_;
	LHG6_ =      LHG1_      /Ntilde1_*Ntilde6_;
	KPT6_ =      KPT1_      /Ntilde1_*Ntilde6_;

	KPW6_ =      KPW1_      /Ntilde1_*Ntilde6_;
	IKP6_ =      IKP1_      /Ntilde1_*Ntilde6_;
    IHP6_ =      IHP1_      /Ntilde1_*Ntilde6_;
    P6_ =        P1_        ;
	YWC6_ =      YWC1_      /Ntilde1_*Ntilde6_;
	X6_ =        X1_        /Ntilde1_*Ntilde6_;
...
%some aggregation and population
	...
	N5b_ = 100*Ntilde5_ * varpi_;
	N5l_ = 100*Ntilde5_ * (1-varpi_);
	N5_ = N5b_ + N5l_;
	CND6_ = CND6b_ + CND6l_;

	N6b_ = 100*Ntilde6_ * varpi_;
	N6l_ = 100*Ntilde6_ * (1-varpi_);
	N6_ = N6b_ + N6l_;
...
%also the production of public goods
    ...
    Y5_ = OmegaY_ *Ntilde5_ /Ntilde1_;
    YND5_ = ( CND5_ / OmegaND_ / LND5_ ^ ( 1 - alphaND ) ) ^ ( 1 / alphaND );
    PND5_DIVIDEDP5_ = YND5_ / CND5_ / alphaND;
	PND5_ = PND5_DIVIDEDP5_ * P5_;

	beta5l_ = betabarl - bbeta * log( CND5_ * PND5_DIVIDEDP5_ / Y5_ );
	
	YCG5_ = tauCG_ * alphaCG * Y5_;
	CG5_ = OmegaCG_ * YCG5_ ^ alphaCG * LCG5_ ^ ( 1 - alphaCG );

    Y6_ = OmegaY_ *Ntilde6_ /Ntilde1_;
    YND6_ = ( CND6_ / OmegaND_ / LND6_ ^ ( 1 - alphaND ) ) ^ ( 1 / alphaND );
    PND6_DIVIDEDP6_ = YND6_ / CND6_ / alphaND;
	PND6_ = PND6_DIVIDEDP6_ * P6_;

	beta6l_ = betabarl - bbeta * log( CND6_ * PND6_DIVIDEDP6_ / Y6_ );
	
	YCG6_ = tauCG_ * alphaCG * Y6_;
	CG6_ = OmegaCG_ * YCG6_ ^ alphaCG * LCG6_ ^ ( 1 - alphaCG );
...
%Consumption composite
		...
		CDBar5l_ = CD5l_ / CND5l_ * gCDBar_ ^ ( -varrhoCD / ( 1 - varrhoCD ) );
		CP5l_ = N5l_ * OmegaCP_ * ( CDBar5l_ / gCDBar_ ) ^ alphaCD * ( alphaCD * ( CD5l_ / N5l_ / ( CDBar5l_ / gCDBar_ ) ) ^ ( ( eCP - 1 ) / eCP )  +  ( 1 - alphaCD ) * ( CND5l_ / N5l_ ) ^ ( ( eCP - 1 ) / eCP ) ) ^ ( eCP / ( eCP - 1 ) );
		CPBar5l_ = CP5l_ / CG5_ * ( N5b_ + N5l_ ) / N5l_ * gCPBar_ ^ ( -varrhoCP / ( 1 - varrhoCP ) );
		C5l_ = N5l_ * OmegaC_ * ( CPBar5l_ / gCPBar_ ) ^ alphaCP * ( alphaCP * ( CP5l_ / N5l_ / ( CPBar5l_ / gCPBar_ ) ) ^ ( ( eC - 1 ) / eC )  +  ( 1 - alphaCP ) * ( CG5_ / ( N5b_ + N5l_ ) ) ^ ( ( eC - 1 ) / eC ) ) ^ ( eC / ( eC - 1 ) );
		CBar5l_ = N5l_ * ( C5l_ / N5l_ ) * ( gCBar_ / GN_ ) ^ ( -varrhoC / ( 1 - varrhoC ) );





		CDBar6l_ = CD6l_ / CND6l_ * gCDBar_ ^ ( -varrhoCD / ( 1 - varrhoCD ) );
		CP6l_ = N6l_ * OmegaCP_ * ( CDBar6l_ / gCDBar_ ) ^ alphaCD * ( alphaCD * ( CD6l_ / N6l_ / ( CDBar6l_ / gCDBar_ ) ) ^ ( ( eCP - 1 ) / eCP )  +  ( 1 - alphaCD ) * ( CND6l_ / N6l_ ) ^ ( ( eCP - 1 ) / eCP ) ) ^ ( eCP / ( eCP - 1 ) );
		CPBar6l_ = CP6l_ / CG6_ * ( N6b_ + N6l_ ) / N6l_ * gCPBar_ ^ ( -varrhoCP / ( 1 - varrhoCP ) );
		C6l_ = N6l_ * OmegaC_ * ( CPBar6l_ / gCPBar_ ) ^ alphaCP * ( alphaCP * ( CP6l_ / N6l_ / ( CPBar6l_ / gCPBar_ ) ) ^ ( ( eC - 1 ) / eC )  +  ( 1 - alphaCP ) * ( CG6_ / ( N6b_ + N6l_ ) ) ^ ( ( eC - 1 ) / eC ) ) ^ ( eC / ( eC - 1 ) );
		CBar6l_ = N6l_ * ( C6l_ / N6l_ ) * ( gCBar_ / GN_ ) ^ ( -varrhoC / ( 1 - varrhoC ) );
...
%STD and 2 engineering equations
	...
	VV5l_=beta5l_ * gV_ ^ -sigma;

    Xi5_ = VV5l_ * glambda_B_;
	VV6l_=beta6l_ * gV_ ^ -sigma;

    Xi6_ = VV6l_ * glambda_B_;
	Xi_ = Xi1_;
	Q_ = Xi_;
...
%ND in 5
	...
	tauLNDCG5_ = tauLa_ + tauLb_ * log( WNDCG5_ );


		V5l_DIVIDEDU5l_ = ( ( 1 - beta5l_ ) * N5l_ ^ ( xi - 1 + sigma ) / ( 1 - beta5l_ * gV_ ^ ( 1 - sigma ) ) ) ^ ( 1 / ( 1 - sigma ) );
		lambda_B5l_ = ( V5l_DIVIDEDU5l_ ) ^ sigma  * ( 1 - beta5l_ ) * N5l_ ^ ( xi - 1 + sigma ) * kappaNDCG_ * ( LNDCG5l_ / N5l_ ) ^ nuNDCG * CBar5l_ / N5l_ / ( gCBar_ / GN_ ) / WNDCG5_ / ( 1 - tauLNDCG5_ );
%D in 5
%	WD5_ = (( ...
%		( 1 - tauLD5_ ) ^ ( 1 / nuD ) * ( ...
%		( lambda_B5l_ / ( V5l_DIVIDEDU5l_ ) ^ sigma / ( 1 - beta5l_ ) / N5l_ ^ ( xi - 1 + sigma ) / ( CBar5l_ / gCBar_ / ( N5l_ / GN_ ) ) / kappaD_ ) ^ ( 1 / nuD ) * N5l_ + ...
%		( lambda_B5b_ / ( V5b_DIVIDEDU5b_ ) ^ sigma / ( 1 - beta5b_ ) / N5b_ ^ ( xi - 1 + sigma ) / ( CBar5b_ / gCBar_ / ( N5b_ / GN_ ) ) / kappaD_ ) ^ ( 1 / nuD ) * N5b_ ...
%		) * OmegaD_ / ID5_ / ( ( 1 - alphaD ) / alphaD ) ^ alphaD / P5_ ^ alphaD ...
%		) ^ ( -1 / ( alphaD + 1 / nuD ) ));	
...
%H in 5
    ...
    YHP5_ = ( IHP5_ / LHP5_ ^ ( 1 - alphaHP ) / OmegaHP_ ) ^ ( 1 / alphaHP );
    PHP5_ = YHP5_ / IHP5_ / alphaHP * P5_;
...
%K in 5
	...
	YKP5_ = ( IKP5_ / LKP5_ ^ ( 1 - alphaKP ) / OmegaKP_ ) ^ ( 1 / alphaKP );
    PKP5_ = YKP5_ / IKP5_ / alphaKP * P5_;
...
%ND in 6
	...
	tauLNDCG6_ = tauLa_ + tauLb_ * log( WNDCG6_ );


		V6l_DIVIDEDU6l_ = ( ( 1 - beta6l_ ) * N6l_ ^ ( xi - 1 + sigma ) / ( 1 - beta6l_ * gV_ ^ ( 1 - sigma ) ) ) ^ ( 1 / ( 1 - sigma ) );
		lambda_B6l_ = ( V6l_DIVIDEDU6l_ ) ^ sigma  * ( 1 - beta6l_ ) * N6l_ ^ ( xi - 1 + sigma ) * kappaNDCG_ * ( LNDCG6l_ / N6l_ ) ^ nuNDCG * CBar6l_ / N6l_ / ( gCBar_ / GN_ ) / WNDCG6_ / ( 1 - tauLNDCG6_ );
%D in 6
%	WD6_ = (( ...
%		( 1 - tauLD6_ ) ^ ( 1 / nuD ) * ( ...
%		( lambda_B6l_ / ( V6l_DIVIDEDU6l_ ) ^ sigma / ( 1 - beta6l_ ) / N6l_ ^ ( xi - 1 + sigma ) / ( CBar6l_ / gCBar_ / ( N6l_ / GN_ ) ) / kappaD_ ) ^ ( 1 / nuD ) * N6l_ + ...
%		( lambda_B6b_ / ( V6b_DIVIDEDU6b_ ) ^ sigma / ( 1 - beta6b_ ) / N6b_ ^ ( xi - 1 + sigma ) / ( CBar6b_ / gCBar_ / ( N6b_ / GN_ ) ) / kappaD_ ) ^ ( 1 / nuD ) * N6b_ ...
%		) * OmegaD_ / ID6_ / ( ( 1 - alphaD ) / alphaD ) ^ alphaD / P6_ ^ alphaD ...
%		) ^ ( -1 / ( alphaD + 1 / nuD ) ));	
...
%H in 6
    ...
    YHP6_ = ( IHP6_ / LHP6_ ^ ( 1 - alphaHP ) / OmegaHP_ ) ^ ( 1 / alphaHP );
    PHP6_ = YHP6_ / IHP6_ / alphaHP * P6_;
...
%K in 6
	...
	YKP6_ = ( IKP6_ / LKP6_ ^ ( 1 - alphaKP ) / OmegaKP_ ) ^ ( 1 / alphaKP );
    PKP6_ = YKP6_ / IKP6_ / alphaKP * P6_;
...
%Labor supply in W/T/NT, SW/ST/SNT, h
    ...
    LSNT1_ = LSNT1l_;
		...
		%WW5_ = ( V5l_DIVIDEDU5l_ ) ^ sigma  * ( 1 - beta5l_ ) * N5l_ ^ ( xi - 1 + sigma ) * kappaW_ * LW5l_ ^ nuW * CBar5l_ / N5l_ ^ ( 1 + nuW ) / ( gCBar_ / GN_ ) / lambda_B5l_ / ( 1 - tauLW5_ );
		WWini5_ = ( V5l_DIVIDEDU5l_ ) ^ sigma  * ( 1 - beta5l_ ) * N5l_ ^ ( xi - 1 + sigma ) * kappaW_ * LW5l_ ^ nuW * CBar5l_ / N5l_ ^ ( 1 + nuW ) / ( gCBar_ / GN_ ) / lambda_B5l_ / ( 1 - tauLa_ );
		WW5_ = fzero( @(WW5_) real(WW5_ - ( V5l_DIVIDEDU5l_ ) ^ sigma  * ( 1 - beta5l_ ) * N5l_ ^ ( xi - 1 + sigma ) * kappaW_ * LW5l_ ^ nuW * CBar5l_ / N5l_ ^ ( 1 + nuW ) / ( gCBar_ / GN_ ) / lambda_B5l_ / ( 1 - tauLa_ - tauLb_ * log( WW5_ ) )), WWini5_, optimset( 'display', 'off' ) );

		%WT5_ = ( V5l_DIVIDEDU5l_ ) ^ sigma  * ( 1 - beta5l_ ) * N5l_ ^ ( xi - 1 + sigma ) * kappaT_ * LT5l_ ^ nuT * CBar5l_ / N5l_ ^ ( 1 + nuT ) / ( gCBar_ / GN_ ) / lambda_B5l_ / ( 1 - tauLT5_ );
		WTini5_ = ( V5l_DIVIDEDU5l_ ) ^ sigma  * ( 1 - beta5l_ ) * N5l_ ^ ( xi - 1 + sigma ) * kappaT_ * LT5l_ ^ nuT * CBar5l_ / N5l_ ^ ( 1 + nuT ) / ( gCBar_ / GN_ ) / lambda_B5l_ / ( 1 - tauLa_ );
		WT5_ = fzero( @(WT5_) real(WT5_ - ( V5l_DIVIDEDU5l_ ) ^ sigma  * ( 1 - beta5l_ ) * N5l_ ^ ( xi - 1 + sigma ) * kappaT_ * LT5l_ ^ nuT * CBar5l_ / N5l_ ^ ( 1 + nuT ) / ( gCBar_ / GN_ ) / lambda_B5l_ / ( 1 - tauLa_ - tauLb_ * log( WT5_ ) )), WTini5_, optimset( 'display', 'off' ) );

		%WNT5_ = ( V5l_DIVIDEDU5l_ ) ^ sigma  * ( 1 - beta5l_ ) * N5l_ ^ ( xi - 1 + sigma ) * kappaNT_ * LNT5l_ ^ nuNT * CBar5l_ / N5l_ ^ ( 1 + nuNT ) / ( gCBar_ / GN_ ) / lambda_B5l_ / ( 1 - tauLNT5_ );



		%WSW5_ = ( V5l_DIVIDEDU5l_ ) ^ sigma  * ( 1 - beta5l_ ) * N5l_ ^ ( xi - 1 + sigma ) * kappaSW_ * LSW5l_ ^ nuSW * CBar5l_ / N5l_ ^ ( 1 + nuSW ) / ( gCBar_ / GN_ ) / lambda_B5l_ / ( 1 - tauLSW5_ );
		WSWini5_ = ( V5l_DIVIDEDU5l_ ) ^ sigma  * ( 1 - beta5l_ ) * N5l_ ^ ( xi - 1 + sigma ) * kappaSW_ * LSW5l_ ^ nuSW * CBar5l_ / N5l_ ^ ( 1 + nuSW ) / ( gCBar_ / GN_ ) / lambda_B5l_ / ( 1 - tauLa_ );
		WSW5_ = fzero( @(WSW5_) real(WSW5_ - ( V5l_DIVIDEDU5l_ ) ^ sigma  * ( 1 - beta5l_ ) * N5l_ ^ ( xi - 1 + sigma ) * kappaSW_ * LSW5l_ ^ nuSW * CBar5l_ / N5l_ ^ ( 1 + nuSW ) / ( gCBar_ / GN_ ) / lambda_B5l_ / ( 1 - tauLa_ - tauLb_ * log( WSW5_ ) )), WSWini5_, optimset( 'display', 'off' ) );

		%WST5_ = ( V5l_DIVIDEDU5l_ ) ^ sigma  * ( 1 - beta5l_ ) * N5l_ ^ ( xi - 1 + sigma ) * kappaST_ * LST5l_ ^ nuST * CBar5l_ / N5l_ ^ ( 1 + nuST ) / ( gCBar_ / GN_ ) / lambda_B5l_ / ( 1 - tauLST5_ );
		WSTini5_ = ( V5l_DIVIDEDU5l_ ) ^ sigma  * ( 1 - beta5l_ ) * N5l_ ^ ( xi - 1 + sigma ) * kappaST_ * LST5l_ ^ nuST * CBar5l_ / N5l_ ^ ( 1 + nuST ) / ( gCBar_ / GN_ ) / lambda_B5l_ / ( 1 - tauLa_ );
		WST5_ = fzero( @(WST5_) real(WST5_ - ( V5l_DIVIDEDU5l_ ) ^ sigma  * ( 1 - beta5l_ ) * N5l_ ^ ( xi - 1 + sigma ) * kappaST_ * LST5l_ ^ nuST * CBar5l_ / N5l_ ^ ( 1 + nuST ) / ( gCBar_ / GN_ ) / lambda_B5l_ / ( 1 - tauLa_ - tauLb_ * log( WST5_ ) )), WSTini5_, optimset( 'display', 'off' ) );

		%WSNT5_ = ( V5l_DIVIDEDU5l_ ) ^ sigma  * ( 1 - beta5l_ ) * N5l_ ^ ( xi - 1 + sigma ) * kappaSNT_ * LSNT5l_ ^ nuSNT * CBar5l_ / N5l_ ^ ( 1 + nuSNT ) / ( gCBar_ / GN_ ) / lambda_B5l_ / ( 1 - tauLSNT5_ );
		...
		%WW6_ = ( V6l_DIVIDEDU6l_ ) ^ sigma  * ( 1 - beta6l_ ) * N6l_ ^ ( xi - 1 + sigma ) * kappaW_ * LW6l_ ^ nuW * CBar6l_ / N6l_ ^ ( 1 + nuW ) / ( gCBar_ / GN_ ) / lambda_B6l_ / ( 1 - tauLW6_ );
		WWini6_ = ( V6l_DIVIDEDU6l_ ) ^ sigma  * ( 1 - beta6l_ ) * N6l_ ^ ( xi - 1 + sigma ) * kappaW_ * LW6l_ ^ nuW * CBar6l_ / N6l_ ^ ( 1 + nuW ) / ( gCBar_ / GN_ ) / lambda_B6l_ / ( 1 - tauLa_ );
		WW6_ = fzero( @(WW6_) real(WW6_ - ( V6l_DIVIDEDU6l_ ) ^ sigma  * ( 1 - beta6l_ ) * N6l_ ^ ( xi - 1 + sigma ) * kappaW_ * LW6l_ ^ nuW * CBar6l_ / N6l_ ^ ( 1 + nuW ) / ( gCBar_ / GN_ ) / lambda_B6l_ / ( 1 - tauLa_ - tauLb_ * log( WW6_ ) )), WWini6_, optimset( 'display', 'off' ) );

		%WT6_ = ( V6l_DIVIDEDU6l_ ) ^ sigma  * ( 1 - beta6l_ ) * N6l_ ^ ( xi - 1 + sigma ) * kappaT_ * LT6l_ ^ nuT * CBar6l_ / N6l_ ^ ( 1 + nuT ) / ( gCBar_ / GN_ ) / lambda_B6l_ / ( 1 - tauLT6_ );
		WTini6_ = ( V6l_DIVIDEDU6l_ ) ^ sigma  * ( 1 - beta6l_ ) * N6l_ ^ ( xi - 1 + sigma ) * kappaT_ * LT6l_ ^ nuT * CBar6l_ / N6l_ ^ ( 1 + nuT ) / ( gCBar_ / GN_ ) / lambda_B6l_ / ( 1 - tauLa_ );
		WT6_ = fzero( @(WT6_) real(WT6_ - ( V6l_DIVIDEDU6l_ ) ^ sigma  * ( 1 - beta6l_ ) * N6l_ ^ ( xi - 1 + sigma ) * kappaT_ * LT6l_ ^ nuT * CBar6l_ / N6l_ ^ ( 1 + nuT ) / ( gCBar_ / GN_ ) / lambda_B6l_ / ( 1 - tauLa_ - tauLb_ * log( WT6_ ) )), WTini6_, optimset( 'display', 'off' ) );

		%WNT6_ = ( V6l_DIVIDEDU6l_ ) ^ sigma  * ( 1 - beta6l_ ) * N6l_ ^ ( xi - 1 + sigma ) * kappaNT_ * LNT6l_ ^ nuNT * CBar6l_ / N6l_ ^ ( 1 + nuNT ) / ( gCBar_ / GN_ ) / lambda_B6l_ / ( 1 - tauLNT6_ );



		%WSW6_ = ( V6l_DIVIDEDU6l_ ) ^ sigma  * ( 1 - beta6l_ ) * N6l_ ^ ( xi - 1 + sigma ) * kappaSW_ * LSW6l_ ^ nuSW * CBar6l_ / N6l_ ^ ( 1 + nuSW ) / ( gCBar_ / GN_ ) / lambda_B6l_ / ( 1 - tauLSW6_ );
		WSWini6_ = ( V6l_DIVIDEDU6l_ ) ^ sigma  * ( 1 - beta6l_ ) * N6l_ ^ ( xi - 1 + sigma ) * kappaSW_ * LSW6l_ ^ nuSW * CBar6l_ / N6l_ ^ ( 1 + nuSW ) / ( gCBar_ / GN_ ) / lambda_B6l_ / ( 1 - tauLa_ );
		WSW6_ = fzero( @(WSW6_) real(WSW6_ - ( V6l_DIVIDEDU6l_ ) ^ sigma  * ( 1 - beta6l_ ) * N6l_ ^ ( xi - 1 + sigma ) * kappaSW_ * LSW6l_ ^ nuSW * CBar6l_ / N6l_ ^ ( 1 + nuSW ) / ( gCBar_ / GN_ ) / lambda_B6l_ / ( 1 - tauLa_ - tauLb_ * log( WSW6_ ) )), WSWini6_, optimset( 'display', 'off' ) );

		%WST6_ = ( V6l_DIVIDEDU6l_ ) ^ sigma  * ( 1 - beta6l_ ) * N6l_ ^ ( xi - 1 + sigma ) * kappaST_ * LST6l_ ^ nuST * CBar6l_ / N6l_ ^ ( 1 + nuST ) / ( gCBar_ / GN_ ) / lambda_B6l_ / ( 1 - tauLST6_ );
		WSTini6_ = ( V6l_DIVIDEDU6l_ ) ^ sigma  * ( 1 - beta6l_ ) * N6l_ ^ ( xi - 1 + sigma ) * kappaST_ * LST6l_ ^ nuST * CBar6l_ / N6l_ ^ ( 1 + nuST ) / ( gCBar_ / GN_ ) / lambda_B6l_ / ( 1 - tauLa_ );
		WST6_ = fzero( @(WST6_) real(WST6_ - ( V6l_DIVIDEDU6l_ ) ^ sigma  * ( 1 - beta6l_ ) * N6l_ ^ ( xi - 1 + sigma ) * kappaST_ * LST6l_ ^ nuST * CBar6l_ / N6l_ ^ ( 1 + nuST ) / ( gCBar_ / GN_ ) / lambda_B6l_ / ( 1 - tauLa_ - tauLb_ * log( WST6_ ) )), WSTini6_, optimset( 'display', 'off' ) );

		%WSNT6_ = ( V6l_DIVIDEDU6l_ ) ^ sigma  * ( 1 - beta6l_ ) * N6l_ ^ ( xi - 1 + sigma ) * kappaSNT_ * LSNT6l_ ^ nuSNT * CBar6l_ / N6l_ ^ ( 1 + nuSNT ) / ( gCBar_ / GN_ ) / lambda_B6l_ / ( 1 - tauLSNT6_ );
...
%first, built prices from down to up
	...
	PscriptX4_ = 1 / ( exp( -o * ( log( X4_ / X_ ) - log( YX4_ / YWC_ ) ) ^ 2 ) - scriptX4_ * 2 * o * ( log( X4_ / X_ ) - log( YX4_ / YWC_ ) ) * (X_ - X4_) / X4_ / X_ );
		...
		RKPT5_ = RKPT5_DIVIDEDPKP5_ * PKP5_;
		RHPT5_ = RHPT5_DIVIDEDPHP5_ * PHP5_;


		RKPW5_ = RKPW5_DIVIDEDPKP5_ * PKP5_;
		RHPW5_ = RHPW5_DIVIDEDPHP5_ * PHP5_;
	
	%scriptX
    YX5_ = YWC5_;
	scriptX5_ = X5_ * exp( -o * ( log( X5_ / X_ ) - log( YX5_ / YWC_ ) ) ^ 2 );
	PscriptX5_ = 1 / ( exp( -o * ( log( X5_ / X_ ) - log( YX5_ / YWC_ ) ) ^ 2 ) - scriptX5_ * 2 * o * ( log( X5_ / X_ ) - log( YX5_ / YWC_ ) ) * (X_ - X5_) / X5_ / X_ );

	
		%HL in T5
		PHLT5_ = 1 / ( ( alphaHL / RHPT5_ ) ^ alphaHL * ( ( 1 - alphaHL ) / WST5_ ) ^ ( 1 - alphaHL ) * OmegaHLT_ );
		
		%KGKP
		%I can't form the price easily because decreasing return to scale for firms. So I have to guess KPT5_
		%Can I decompose total spendings on factors untill I got RKT5_TIMESKT5_ in each S0? Yes for nontradable but No for widget and tradable due to CES
        FKT5_ = OmegaKW_ * ( KG5_  / gKG_ ) ^ alphaK * ( KUW5_ * KPW5_ ) ^ ( 1 - alphaK ) * FKtilde / ( 1 + FKtilde );
		KT5_ = OmegaKT_ * ( KG5_ / gKG_ ) ^ alphaK * ( KUT5_ * KPT5_ ) ^ ( 1 - alphaK ) - FKT5_;
		RKT5_ = RKPT5_ * KUT5_ * KPT5_ / ( 1 - alphaK ) / ( KT5_ + FKT5_ );
		
		%KL in T5
		%auxilary, gether growth terms in production of capital engineering composite
		YKLTempT5_ = OmegaKLT_ * gKBar_ ^ ( -alphaKL / ( 1 - varrhoKL ) ) * ( alphaKL * gKBar_ ^ ( 1 / ( 1 - varrhoKL ) * ( eKLT - 1 ) / eKLT ) + 1 - alphaKL ) ^ ( eKLT / ( eKLT - 1 ) );
		%auxilary, gether growth terms in FOC of capital and engineering
		PKLTempT5_ = OmegaKLT_ ^ ( 1 - 1 / eKLT ) * gKBar_ ^ ( -1 / ( 1 - varrhoKL ) * ( alphaKL - 1 ) * ( eKLT - 1 ) / eKLT ) * YKLTempT5_ ^ ( 1/ eKLT - 1 )...
			- Xi5_ * OmegaKLT_ ^ ( 1 - 1 / eKLT ) * gK_ * gPKL_ * gKBar_ ^ ( -varrhoKL / ( 1 - varrhoKL ) * ( alphaKL - 1 ) * ( eKLT - 1 ) / eKLT ) * ( gYKL_ / gK_ ) ^ ( 1 / eKLT ) * YKLTempT5_ ^ ( 1/ eKLT - 1 )...
			+ Xi5_ * GN_ * GAs_ ^ a_ * ( 1 - varrhoKL );
		
		PKLT5_ = 1 / ( ( PKLTempT5_ * alphaKL / ( 1 - varrhoKL * Xi5_ * GN_ * GAs_ ^ a_ ) / RKT5_ ) ^ alphaKL * ( 1 / WT5_ - PKLTempT5_ * alphaKL / ( 1 - varrhoKL * Xi5_ * GN_ * GAs_ ^ a_ ) / WT5_ ) ^ ( 1 - alphaKL ) * YKLTempT5_ );

		%HLX in T5
		YHLXTempT5_ = OmegaHLXT_ * gYHLBar_ ^ ( -alphaHLX / ( 1 - varrhoHLX ) ) * ( alphaHLX * gYHLBar_ ^ ( 1 / ( 1 - varrhoHLX ) * ( eHLXT - 1 ) / eHLXT ) + 1 - alphaHLX ) ^ ( eHLXT / ( eHLXT - 1 ) );
		PHLXTempT5_ = OmegaHLXT_ ^ ( 1 - 1 / eHLXT ) * gYHLBar_ ^ ( -1 / ( 1 - varrhoHLX ) * ( alphaHLX - 1 ) * ( eHLXT - 1 ) / eHLXT ) * YHLXTempT5_ ^ ( 1/ eHLXT - 1 )...
			- Xi5_ * OmegaHLXT_ ^ ( 1 - 1 / eHLXT ) * gYHL_ * gPHLX_ * gYHLBar_^ ( -varrhoHLX / ( 1 - varrhoHLX ) * ( alphaHLX - 1 ) * ( eHLXT - 1 ) / eHLXT ) *  ( gYHLX_ / gYHL_ ) ^ ( 1 / eHLXT  ) * YHLXTempT5_ ^ ( 1/ eHLXT - 1 )...
			+ Xi5_ * GN_ * GAs_ ^ a_ * ( 1 - varrhoHLX );
		
		PHLXT5_ = 1 / ( ( PHLXTempT5_ * alphaHLX / ( 1 - varrhoHLX * Xi5_ * GN_ * GAs_ ^ a_ ) / PHLT5_ ) ^ alphaHLX * ( 1 / ( 1 + tauscriptXT_ ) / PscriptX5_ - PHLXTempT5_ * alphaHLX / ( 1 - varrhoHLX * Xi5_ * GN_ * GAs_ ^ a_ ) / ( 1 + tauscriptXT_ )  / PscriptX5_ ) ^ ( 1 - alphaHLX ) * YHLXTempT5_ );

		%Y in T5
		YTempT5_ = OmegaT_ * gYHLXBar_ ^ ( -alphaY / ( 1 - varrhoY ) ) * ( alphaY * gYHLXBar_ ^ ( 1 / ( 1 - varrhoY ) * ( eYT - 1 ) / eYT ) + 1 - alphaY ) ^ ( eYT / ( eYT - 1 ) );
		PTempT5_ = OmegaT_ ^ ( 1 - 1 / eYT ) * gYHLXBar_ ^ ( -1 / ( 1 - varrhoY ) * ( alphaY - 1 ) * ( eYT - 1 ) / eYT ) * YTempT5_ ^ ( 1/ eYT - 1 )...
			- Xi5_ * OmegaT_ ^ ( 1 - 1 / eYT ) * gYHLX_ * gPS_ * gYHLXBar_ ^ (  -varrhoY / ( 1 - varrhoY ) * ( alphaY - 1 ) * ( eYT - 1 ) / eYT ) *  ( gYS_ / gYHLX_ ) ^ ( 1 / eYT  ) * YTempT5_ ^ ( 1/ eYT - 1 )...
			+ Xi5_ * GN_ * GAs_ ^ a_ * ( 1 - varrhoY );
		
		PT5_ = 1 / ( ( PTempT5_ * alphaY / ( 1 - varrhoY * Xi5_ * GN_ * GAs_ ^ a_ ) / PHLXT5_ ) ^ alphaY * ( 1 / PKLT5_ - PTempT5_ * alphaY / ( 1 - varrhoY * Xi5_ * GN_ * GAs_ ^ a_ ) / PKLT5_ ) ^ ( 1 - alphaY ) * YTempT5_ );
		%HL in NT5

		
		%KGKP
		%I can't form the price easily because decreasing return to scale for firms. So I have to guess KPNT5_
		%Can I decompose total spendings on factors untill I got RKNT5_TIMESKNT5_ in each S0? Yes for nontradable but No for widget and tradable due to CES
		...
		%HL in W5
		PHLW5_ = 1 / ( ( alphaHL / RHPW5_ ) ^ alphaHL * ( ( 1 - alphaHL ) / WSW5_ ) ^ ( 1 - alphaHL ) * OmegaHLW_ );
		
		%KGKP
		%I can't form the price easily because decreasing return to scale for firms. So I have to guess KPW5_
		%Can I decompose total spendings on factors untill I got RKW5_TIMESKW5_ in each S0? Yes for nontradable but No for widget and tradable due to CES
        FKW5_ = OmegaKW_ * ( KG5_  / gKG_ ) ^ alphaK * ( KUW5_ * KPW5_ ) ^ ( 1 - alphaK ) * FKtilde / ( 1 + FKtilde );
		KW5_ = OmegaKW_ * ( KG5_ / gKG_ ) ^ alphaK * ( KUW5_ * KPW5_ ) ^ ( 1 - alphaK ) - FKW5_;
		RKW5_ = RKPW5_ * KUW5_ * KPW5_ / ( 1 - alphaK ) / ( KW5_ + FKW5_ );
		
		%KL in W5
		%auxilary, gether growth terms in production of capital engineering composite
		YKLTempW5_ = OmegaKLW_ * gKBar_ ^ ( -alphaKL / ( 1 - varrhoKL ) ) * ( alphaKL * gKBar_ ^ ( 1 / ( 1 - varrhoKL ) * ( eKLW - 1 ) / eKLW ) + 1 - alphaKL ) ^ ( eKLW / ( eKLW - 1 ) );
		%auxilary, gether growth terms in FOC of capital and engineering
		PKLTempW5_ = OmegaKLW_ ^ ( 1 - 1 / eKLW ) * gKBar_ ^ ( -1 / ( 1 - varrhoKL ) * ( alphaKL - 1 ) * ( eKLW - 1 ) / eKLW ) * YKLTempW5_ ^ ( 1/ eKLW - 1 )...
			- Xi5_ * OmegaKLW_ ^ ( 1 - 1 / eKLW ) * gK_ * gPKL_ * gKBar_ ^ ( -varrhoKL / ( 1 - varrhoKL ) * ( alphaKL - 1 ) * ( eKLW - 1 ) / eKLW ) * ( gYKL_ / gK_ ) ^ ( 1 / eKLW ) * YKLTempW5_ ^ ( 1/ eKLW - 1 )...
			+ Xi5_ * GN_ * GAs_ ^ a_ * ( 1 - varrhoKL );
		
		PKLW5_ = 1 / ( ( PKLTempW5_ * alphaKL / ( 1 - varrhoKL * Xi5_ * GN_ * GAs_ ^ a_ ) / RKW5_ ) ^ alphaKL * ( 1 / WW5_ - PKLTempW5_ * alphaKL / ( 1 - varrhoKL * Xi5_ * GN_ * GAs_ ^ a_ ) / WW5_ ) ^ ( 1 - alphaKL ) * YKLTempW5_ );

		%HLX in W5
		YHLXTempW5_ = OmegaHLXW_ * gYHLBar_ ^ ( -alphaHLX / ( 1 - varrhoHLX ) ) * ( alphaHLX * gYHLBar_ ^ ( 1 / ( 1 - varrhoHLX ) * ( eHLXW - 1 ) / eHLXW ) + 1 - alphaHLX ) ^ ( eHLXW / ( eHLXW - 1 ) );
		PHLXTempW5_ = OmegaHLXW_ ^ ( 1 - 1 / eHLXW ) * gYHLBar_ ^ ( -1 / ( 1 - varrhoHLX ) * ( alphaHLX - 1 ) * ( eHLXW - 1 ) / eHLXW ) * YHLXTempW5_ ^ ( 1/ eHLXW - 1 )...
			- Xi5_ * OmegaHLXW_ ^ ( 1 - 1 / eHLXW ) * gYHL_ * gPHLX_ * gYHLBar_^ ( -varrhoHLX / ( 1 - varrhoHLX ) * ( alphaHLX - 1 ) * ( eHLXW - 1 ) / eHLXW ) *  ( gYHLX_ / gYHL_ ) ^ ( 1 / eHLXW  ) * YHLXTempW5_ ^ ( 1/ eHLXW - 1 )...
			+ Xi5_ * GN_ * GAs_ ^ a_ * ( 1 - varrhoHLX );
		
		PHLXW5_ = 1 / ( ( PHLXTempW5_ * alphaHLX / ( 1 - varrhoHLX * Xi5_ * GN_ * GAs_ ^ a_ ) / PHLW5_ ) ^ alphaHLX * ( 1 / ( 1 + tauscriptXW_ ) / PscriptX5_ - PHLXTempW5_ * alphaHLX / ( 1 - varrhoHLX * Xi5_ * GN_ * GAs_ ^ a_ ) / ( 1 + tauscriptXW_ )  / PscriptX5_ ) ^ ( 1 - alphaHLX ) * YHLXTempW5_ );

		%Y in W5
		YTempW5_ = OmegaW_ * gYHLXBar_ ^ ( -alphaY / ( 1 - varrhoY ) ) * ( alphaY * gYHLXBar_ ^ ( 1 / ( 1 - varrhoY ) * ( eYW - 1 ) / eYW ) + 1 - alphaY ) ^ ( eYW / ( eYW - 1 ) );
		PTempW5_ = OmegaW_ ^ ( 1 - 1 / eYW ) * gYHLXBar_ ^ ( -1 / ( 1 - varrhoY ) * ( alphaY - 1 ) * ( eYW - 1 ) / eYW ) * YTempW5_ ^ ( 1/ eYW - 1 )...
			- Xi5_ * OmegaW_ ^ ( 1 - 1 / eYW ) * gYHLX_ * gPS_ * gYHLXBar_ ^ (  -varrhoY / ( 1 - varrhoY ) * ( alphaY - 1 ) * ( eYW - 1 ) / eYW ) *  ( gYS_ / gYHLX_ ) ^ ( 1 / eYW  ) * YTempW5_ ^ ( 1/ eYW - 1 )...
			+ Xi5_ * GN_ * GAs_ ^ a_ * ( 1 - varrhoY );
		
		PW5_ = 1 / ( ( PTempW5_ * alphaY / ( 1 - varrhoY * Xi5_ * GN_ * GAs_ ^ a_ ) / PHLXW5_ ) ^ alphaY * ( 1 / PKLW5_ - PTempW5_ * alphaY / ( 1 - varrhoY * Xi5_ * GN_ * GAs_ ^ a_ ) / PKLW5_ ) ^ ( 1 - alphaY ) * YTempW5_ );

		RKPT6_ = RKPT6_DIVIDEDPKP6_ * PKP6_;
		RHPT6_ = RHPT6_DIVIDEDPHP6_ * PHP6_;


		RKPW6_ = RKPW6_DIVIDEDPKP6_ * PKP6_;
		RHPW6_ = RHPW6_DIVIDEDPHP6_ * PHP6_;
	
	%scriptX
    YX6_ = YWC6_;
	scriptX6_ = X6_ * exp( -o * ( log( X6_ / X_ ) - log( YX6_ / YWC_ ) ) ^ 2 );
	PscriptX6_ = 1 / ( exp( -o * ( log( X6_ / X_ ) - log( YX6_ / YWC_ ) ) ^ 2 ) - scriptX6_ * 2 * o * ( log( X6_ / X_ ) - log( YX6_ / YWC_ ) ) * (X_ - X6_) / X6_ / X_ );

	
		%HL in T6
		PHLT6_ = 1 / ( ( alphaHL / RHPT6_ ) ^ alphaHL * ( ( 1 - alphaHL ) / WST6_ ) ^ ( 1 - alphaHL ) * OmegaHLT_ );
		
		%KGKP
		%I can't form the price easily because decreasing return to scale for firms. So I have to guess KPT6_
		%Can I decompose total spendings on factors untill I got RKT6_TIMESKT6_ in each S0? Yes for nontradable but No for widget and tradable due to CES
        FKT6_ = OmegaKW_ * ( KG6_  / gKG_ ) ^ alphaK * ( KUW6_ * KPW6_ ) ^ ( 1 - alphaK ) * FKtilde / ( 1 + FKtilde );
		KT6_ = OmegaKT_ * ( KG6_ / gKG_ ) ^ alphaK * ( KUT6_ * KPT6_ ) ^ ( 1 - alphaK ) - FKT6_;
		RKT6_ = RKPT6_ * KUT6_ * KPT6_ / ( 1 - alphaK ) / ( KT6_ + FKT6_ );
		
		%KL in T6
		%auxilary, gether growth terms in production of capital engineering composite
		YKLTempT6_ = OmegaKLT_ * gKBar_ ^ ( -alphaKL / ( 1 - varrhoKL ) ) * ( alphaKL * gKBar_ ^ ( 1 / ( 1 - varrhoKL ) * ( eKLT - 1 ) / eKLT ) + 1 - alphaKL ) ^ ( eKLT / ( eKLT - 1 ) );
		%auxilary, gether growth terms in FOC of capital and engineering
		PKLTempT6_ = OmegaKLT_ ^ ( 1 - 1 / eKLT ) * gKBar_ ^ ( -1 / ( 1 - varrhoKL ) * ( alphaKL - 1 ) * ( eKLT - 1 ) / eKLT ) * YKLTempT6_ ^ ( 1/ eKLT - 1 )...
			- Xi6_ * OmegaKLT_ ^ ( 1 - 1 / eKLT ) * gK_ * gPKL_ * gKBar_ ^ ( -varrhoKL / ( 1 - varrhoKL ) * ( alphaKL - 1 ) * ( eKLT - 1 ) / eKLT ) * ( gYKL_ / gK_ ) ^ ( 1 / eKLT ) * YKLTempT6_ ^ ( 1/ eKLT - 1 )...
			+ Xi6_ * GN_ * GAs_ ^ a_ * ( 1 - varrhoKL );
		
		PKLT6_ = 1 / ( ( PKLTempT6_ * alphaKL / ( 1 - varrhoKL * Xi6_ * GN_ * GAs_ ^ a_ ) / RKT6_ ) ^ alphaKL * ( 1 / WT6_ - PKLTempT6_ * alphaKL / ( 1 - varrhoKL * Xi6_ * GN_ * GAs_ ^ a_ ) / WT6_ ) ^ ( 1 - alphaKL ) * YKLTempT6_ );

		%HLX in T6
		YHLXTempT6_ = OmegaHLXT_ * gYHLBar_ ^ ( -alphaHLX / ( 1 - varrhoHLX ) ) * ( alphaHLX * gYHLBar_ ^ ( 1 / ( 1 - varrhoHLX ) * ( eHLXT - 1 ) / eHLXT ) + 1 - alphaHLX ) ^ ( eHLXT / ( eHLXT - 1 ) );
		PHLXTempT6_ = OmegaHLXT_ ^ ( 1 - 1 / eHLXT ) * gYHLBar_ ^ ( -1 / ( 1 - varrhoHLX ) * ( alphaHLX - 1 ) * ( eHLXT - 1 ) / eHLXT ) * YHLXTempT6_ ^ ( 1/ eHLXT - 1 )...
			- Xi6_ * OmegaHLXT_ ^ ( 1 - 1 / eHLXT ) * gYHL_ * gPHLX_ * gYHLBar_^ ( -varrhoHLX / ( 1 - varrhoHLX ) * ( alphaHLX - 1 ) * ( eHLXT - 1 ) / eHLXT ) *  ( gYHLX_ / gYHL_ ) ^ ( 1 / eHLXT  ) * YHLXTempT6_ ^ ( 1/ eHLXT - 1 )...
			+ Xi6_ * GN_ * GAs_ ^ a_ * ( 1 - varrhoHLX );
		
		PHLXT6_ = 1 / ( ( PHLXTempT6_ * alphaHLX / ( 1 - varrhoHLX * Xi6_ * GN_ * GAs_ ^ a_ ) / PHLT6_ ) ^ alphaHLX * ( 1 / ( 1 + tauscriptXT_ ) / PscriptX6_ - PHLXTempT6_ * alphaHLX / ( 1 - varrhoHLX * Xi6_ * GN_ * GAs_ ^ a_ ) / ( 1 + tauscriptXT_ )  / PscriptX6_ ) ^ ( 1 - alphaHLX ) * YHLXTempT6_ );

		%Y in T6
		YTempT6_ = OmegaT_ * gYHLXBar_ ^ ( -alphaY / ( 1 - varrhoY ) ) * ( alphaY * gYHLXBar_ ^ ( 1 / ( 1 - varrhoY ) * ( eYT - 1 ) / eYT ) + 1 - alphaY ) ^ ( eYT / ( eYT - 1 ) );
		PTempT6_ = OmegaT_ ^ ( 1 - 1 / eYT ) * gYHLXBar_ ^ ( -1 / ( 1 - varrhoY ) * ( alphaY - 1 ) * ( eYT - 1 ) / eYT ) * YTempT6_ ^ ( 1/ eYT - 1 )...
			- Xi6_ * OmegaT_ ^ ( 1 - 1 / eYT ) * gYHLX_ * gPS_ * gYHLXBar_ ^ (  -varrhoY / ( 1 - varrhoY ) * ( alphaY - 1 ) * ( eYT - 1 ) / eYT ) *  ( gYS_ / gYHLX_ ) ^ ( 1 / eYT  ) * YTempT6_ ^ ( 1/ eYT - 1 )...
			+ Xi6_ * GN_ * GAs_ ^ a_ * ( 1 - varrhoY );
		
		PT6_ = 1 / ( ( PTempT6_ * alphaY / ( 1 - varrhoY * Xi6_ * GN_ * GAs_ ^ a_ ) / PHLXT6_ ) ^ alphaY * ( 1 / PKLT6_ - PTempT6_ * alphaY / ( 1 - varrhoY * Xi6_ * GN_ * GAs_ ^ a_ ) / PKLT6_ ) ^ ( 1 - alphaY ) * YTempT6_ );
		%HL in NT6

		
		%KGKP
		%I can't form the price easily because decreasing return to scale for firms. So I have to guess KPNT6_
		%Can I decompose total spendings on factors untill I got RKNT6_TIMESKNT6_ in each S0? Yes for nontradable but No for widget and tradable due to CES
		...
		%HL in W6
		PHLW6_ = 1 / ( ( alphaHL / RHPW6_ ) ^ alphaHL * ( ( 1 - alphaHL ) / WSW6_ ) ^ ( 1 - alphaHL ) * OmegaHLW_ );
		
		%KGKP
		%I can't form the price easily because decreasing return to scale for firms. So I have to guess KPW6_
		%Can I decompose total spendings on factors untill I got RKW6_TIMESKW6_ in each S0? Yes for nontradable but No for widget and tradable due to CES
        FKW6_ = OmegaKW_ * ( KG6_  / gKG_ ) ^ alphaK * ( KUW6_ * KPW6_ ) ^ ( 1 - alphaK ) * FKtilde / ( 1 + FKtilde );
		KW6_ = OmegaKW_ * ( KG6_ / gKG_ ) ^ alphaK * ( KUW6_ * KPW6_ ) ^ ( 1 - alphaK ) - FKW6_;
		RKW6_ = RKPW6_ * KUW6_ * KPW6_ / ( 1 - alphaK ) / ( KW6_ + FKW6_ );
		
		%KL in W6
		%auxilary, gether growth terms in production of capital engineering composite
		YKLTempW6_ = OmegaKLW_ * gKBar_ ^ ( -alphaKL / ( 1 - varrhoKL ) ) * ( alphaKL * gKBar_ ^ ( 1 / ( 1 - varrhoKL ) * ( eKLW - 1 ) / eKLW ) + 1 - alphaKL ) ^ ( eKLW / ( eKLW - 1 ) );
		%auxilary, gether growth terms in FOC of capital and engineering
		PKLTempW6_ = OmegaKLW_ ^ ( 1 - 1 / eKLW ) * gKBar_ ^ ( -1 / ( 1 - varrhoKL ) * ( alphaKL - 1 ) * ( eKLW - 1 ) / eKLW ) * YKLTempW6_ ^ ( 1/ eKLW - 1 )...
			- Xi6_ * OmegaKLW_ ^ ( 1 - 1 / eKLW ) * gK_ * gPKL_ * gKBar_ ^ ( -varrhoKL / ( 1 - varrhoKL ) * ( alphaKL - 1 ) * ( eKLW - 1 ) / eKLW ) * ( gYKL_ / gK_ ) ^ ( 1 / eKLW ) * YKLTempW6_ ^ ( 1/ eKLW - 1 )...
			+ Xi6_ * GN_ * GAs_ ^ a_ * ( 1 - varrhoKL );
		
		PKLW6_ = 1 / ( ( PKLTempW6_ * alphaKL / ( 1 - varrhoKL * Xi6_ * GN_ * GAs_ ^ a_ ) / RKW6_ ) ^ alphaKL * ( 1 / WW6_ - PKLTempW6_ * alphaKL / ( 1 - varrhoKL * Xi6_ * GN_ * GAs_ ^ a_ ) / WW6_ ) ^ ( 1 - alphaKL ) * YKLTempW6_ );

		%HLX in W6
		YHLXTempW6_ = OmegaHLXW_ * gYHLBar_ ^ ( -alphaHLX / ( 1 - varrhoHLX ) ) * ( alphaHLX * gYHLBar_ ^ ( 1 / ( 1 - varrhoHLX ) * ( eHLXW - 1 ) / eHLXW ) + 1 - alphaHLX ) ^ ( eHLXW / ( eHLXW - 1 ) );
		PHLXTempW6_ = OmegaHLXW_ ^ ( 1 - 1 / eHLXW ) * gYHLBar_ ^ ( -1 / ( 1 - varrhoHLX ) * ( alphaHLX - 1 ) * ( eHLXW - 1 ) / eHLXW ) * YHLXTempW6_ ^ ( 1/ eHLXW - 1 )...
			- Xi6_ * OmegaHLXW_ ^ ( 1 - 1 / eHLXW ) * gYHL_ * gPHLX_ * gYHLBar_^ ( -varrhoHLX / ( 1 - varrhoHLX ) * ( alphaHLX - 1 ) * ( eHLXW - 1 ) / eHLXW ) *  ( gYHLX_ / gYHL_ ) ^ ( 1 / eHLXW  ) * YHLXTempW6_ ^ ( 1/ eHLXW - 1 )...
			+ Xi6_ * GN_ * GAs_ ^ a_ * ( 1 - varrhoHLX );
		
		PHLXW6_ = 1 / ( ( PHLXTempW6_ * alphaHLX / ( 1 - varrhoHLX * Xi6_ * GN_ * GAs_ ^ a_ ) / PHLW6_ ) ^ alphaHLX * ( 1 / ( 1 + tauscriptXW_ ) / PscriptX6_ - PHLXTempW6_ * alphaHLX / ( 1 - varrhoHLX * Xi6_ * GN_ * GAs_ ^ a_ ) / ( 1 + tauscriptXW_ )  / PscriptX6_ ) ^ ( 1 - alphaHLX ) * YHLXTempW6_ );

		%Y in W6
		YTempW6_ = OmegaW_ * gYHLXBar_ ^ ( -alphaY / ( 1 - varrhoY ) ) * ( alphaY * gYHLXBar_ ^ ( 1 / ( 1 - varrhoY ) * ( eYW - 1 ) / eYW ) + 1 - alphaY ) ^ ( eYW / ( eYW - 1 ) );
		PTempW6_ = OmegaW_ ^ ( 1 - 1 / eYW ) * gYHLXBar_ ^ ( -1 / ( 1 - varrhoY ) * ( alphaY - 1 ) * ( eYW - 1 ) / eYW ) * YTempW6_ ^ ( 1/ eYW - 1 )...
			- Xi6_ * OmegaW_ ^ ( 1 - 1 / eYW ) * gYHLX_ * gPS_ * gYHLXBar_ ^ (  -varrhoY / ( 1 - varrhoY ) * ( alphaY - 1 ) * ( eYW - 1 ) / eYW ) *  ( gYS_ / gYHLX_ ) ^ ( 1 / eYW  ) * YTempW6_ ^ ( 1/ eYW - 1 )...
			+ Xi6_ * GN_ * GAs_ ^ a_ * ( 1 - varrhoY );
		
		PW6_ = 1 / ( ( PTempW6_ * alphaY / ( 1 - varrhoY * Xi6_ * GN_ * GAs_ ^ a_ ) / PHLXW6_ ) ^ alphaY * ( 1 / PKLW6_ - PTempW6_ * alphaY / ( 1 - varrhoY * Xi6_ * GN_ * GAs_ ^ a_ ) / PKLW6_ ) ^ ( 1 - alphaY ) * YTempW6_ );
...
%-----------------------------ROW-----------------------------
	...
	%PWC_ is in residual, PX5_ is above
	%I don't form P here because we already use the production function of Y (and effectively the market clearing condition of Y)
	PTC6_ = ( ...
			+ N0_ * ( PT0_ * ( ...
				1 + iotaTM_ + iotaTX_ ...
	...
	%PWC_ is in residual, PX6_ is above
	%I don't form P here because we already use the production function of Y (and effectively the market clearing condition of Y)
...
%then, get quantity by demand from up to down
    ...
    YTC5_ = ( 1 - alphaNC ) * P5_ * Y5_ / PTC5_ / ( 1 + tauTC_ );

    FWC5_=FWCtilde * YWC5_;
    %YWC5_ is guessed, demand of YWP is in the residual
	YWP5_ = ( ( YWC5_ + FWC5_ ) / OmegaWC_ / ( HG5_ / gHG_ ) ^ alphaHW ) ^ ( 1 / ( 1 - alphaHW ) );
	



		YT51_ = ( PTC5_ * OmegaTC_ / ( PT1_ * ( ...
			1 + iotaTM_ + iotaTX_ ...
		) ) ) ^ eT * YTC5_ / OmegaTC_ * N1_;
        ...
        YW51_ = ( PWP5_ * OmegaWP_/ ( PW1_ * ( ...
            1 + iotaWM_ + iotaWX_ ...
        ) ) ) ^ eW * YWP5_ / OmegaWP_ * N1_ / NN_;
    ...
    YTC6_ = ( 1 - alphaNC ) * P6_ * Y6_ / PTC6_ / ( 1 + tauTC_ );

    FWC6_=FWCtilde * YWC6_;
    %YWC6_ is guessed, demand of YWP is in the residual
	YWP6_ = ( ( YWC6_ + FWC6_ ) / OmegaWC_ / ( HG6_ / gHG_ ) ^ alphaHW ) ^ ( 1 / ( 1 - alphaHW ) );
	



		YT61_ = ( PTC6_ * OmegaTC_ / ( PT1_ * ( ...
			1 + iotaTM_ + iotaTX_ ...
		) ) ) ^ eT * YTC6_ / OmegaTC_ * N1_;
        ...
        YW61_ = ( PWP6_ * OmegaWP_/ ( PW1_ * ( ...
            1 + iotaWM_ + iotaWX_ ...
        ) ) ) ^ eW * YWP6_ / OmegaWP_ * N1_ / NN_;
...
%define all production habit in T5



%Demand of HLX in NT5
...
%define all production habit in NT5
...
%define all production habit in W5
...
%define all production habit in T6



%Demand of HLX in NT6
...
%define all production habit in NT6
...
%define all production habit in W6
