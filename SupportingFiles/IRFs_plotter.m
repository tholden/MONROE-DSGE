...
for ii=1:NShock
    ...
    f1n=figure(1+2*(ii-1));
    subplot(3,4,1)
    eval(['plot(oo_.irfs.rGDPpc1_DivFromTrend_',ShockList{ii},'(1:T)/100/M_.params(find(ismember(param_names,[''sigma'',Shockii]))))'])
    title('GDP')
    subplot(3,4,2)
    eval(['plot(oo_.irfs.rPCEpc1_DivFromTrend_',ShockList{ii},'(1:T)/100/M_.params(find(ismember(param_names,[''sigma'',Shockii]))))'])
    title('Private Consumption')
    subplot(3,4,3)
    eval(['plot(oo_.irfs.rPDIpc1_DivFromTrend_',ShockList{ii},'(1:T)/100/M_.params(find(ismember(param_names,[''sigma'',Shockii]))))'])
    title('Private Investment')
    subplot(3,4,4)
    eval(['plot(oo_.irfs.rGSpendingpc1_DivFromTrend_',ShockList{ii},'(1:T)/100/M_.params(find(ismember(param_names,[''sigma'',Shockii]))))'])
    title('Government Spending')
    subplot(3,4,5)
    eval(['plot(oo_.irfs.As_DivFromTrend_',ShockList{ii},'(1:T)/100/M_.params(find(ismember(param_names,[''sigma'',Shockii]))))'])
    title('Frontier Productivity')
    ylabel('Foreign, real per capita, % deviations from SS or trend')
    subplot(3,4,6)
    eval(['plot(oo_.irfs.BEAhpop1_',ShockList{ii},'(1:T)*100/100/M_.params(find(ismember(param_names,[''sigma'',Shockii]))))'])
    title('Hours Worked')
    subplot(3,4,7)
    eval(['plot(oo_.irfs.IHPpc1_DivFromTrend_',ShockList{ii},'(1:T)/100/M_.params(find(ismember(param_names,[''sigma'',Shockii]))))'])
    title('Private H Investment')
    subplot(3,4,8)
    eval(['plot(oo_.irfs.GovDifY1_',ShockList{ii},'(1:T)/100/M_.params(find(ismember(param_names,[''sigma'',Shockii]))))'])
    title('Government Deficit / GDP')
    subplot(3,4,9)
    eval(['plot(oo_.irfs.Xpc1_DivFromTrend_',ShockList{ii},'(1:T)/100/M_.params(find(ismember(param_names,[''sigma'',Shockii]))))'])
    title('Engineering')
    subplot(3,4,10)
    eval(['plot(oo_.irfs.NXY1_',ShockList{ii},'(1:T)/100/M_.params(find(ismember(param_names,[''sigma'',Shockii]))))'])
    title('Net Export / GDP')
    xlabel(['Shock: ',ShockNames{ii},', 1%'])
    subplot(3,4,11)
    eval(['plot(oo_.irfs.PRDY1_',ShockList{ii},'(1:T)/100/M_.params(find(ismember(param_names,[''sigma'',Shockii]))))'])
    title('Private R&D / GDP')
    subplot(3,4,12)
    eval(['plot(oo_.irfs.GRDY1_',ShockList{ii},'(1:T)/100/M_.params(find(ismember(param_names,[''sigma'',Shockii]))))'])
    ...
    f2n=figure(2+2*(ii-1));
    subplot(3,4,1)
    eval(['plot(oo_.irfs.rGDPpc2_DivFromTrend_',ShockList{ii},'(1:T)/100/M_.params(find(ismember(param_names,[''sigma'',Shockii]))))'])
    title('GDP')
    subplot(3,4,2)
    eval(['plot(oo_.irfs.rPCEpc2_DivFromTrend_',ShockList{ii},'(1:T)/100/M_.params(find(ismember(param_names,[''sigma'',Shockii]))))'])
    title('Private Consumption')
    subplot(3,4,3)
    eval(['plot(oo_.irfs.rPDIpc2_DivFromTrend_',ShockList{ii},'(1:T)/100/M_.params(find(ismember(param_names,[''sigma'',Shockii]))))'])
    title('Private Investment')
    subplot(3,4,4)
    eval(['plot(oo_.irfs.rGSpendingpc2_DivFromTrend_',ShockList{ii},'(1:T)/100/M_.params(find(ismember(param_names,[''sigma'',Shockii]))))'])
    title('Government Spending')
    subplot(3,4,5)
    eval(['plot(oo_.irfs.As_DivFromTrend_',ShockList{ii},'(1:T)/100/M_.params(find(ismember(param_names,[''sigma'',Shockii]))))'])
    title('Frontier Productivity')
    ...
    subplot(3,4,6)
    eval(['plot(oo_.irfs.PWThpop2_',ShockList{ii},'(1:T)*100/100/M_.params(find(ismember(param_names,[''sigma'',Shockii]))))'])
    title('Hours Worked')
    subplot(3,4,7)
    eval(['plot(oo_.irfs.IHPpc2_DivFromTrend_',ShockList{ii},'(1:T)/100/M_.params(find(ismember(param_names,[''sigma'',Shockii]))))'])
    title('Private H Investment')
    subplot(3,4,8)
    eval(['plot(oo_.irfs.GovDifY2_',ShockList{ii},'(1:T)/100/M_.params(find(ismember(param_names,[''sigma'',Shockii]))))'])
    title('Government Deficit / GDP')
    subplot(3,4,9)
    eval(['plot(oo_.irfs.Xpc2_DivFromTrend_',ShockList{ii},'(1:T)/100/M_.params(find(ismember(param_names,[''sigma'',Shockii]))))'])
    title('Engineering')
    subplot(3,4,10)
    eval(['plot(oo_.irfs.NXY2_',ShockList{ii},'(1:T)/100/M_.params(find(ismember(param_names,[''sigma'',Shockii]))))'])
    title('Net Export / GDP')
    xlabel(['Shock: ',ShockNames{ii},', 1%'])
    subplot(3,4,11)
    eval(['plot(oo_.irfs.PRDY2_',ShockList{ii},'(1:T)/100/M_.params(find(ismember(param_names,[''sigma'',Shockii]))))'])
    title('Private R&D / GDP')
    subplot(3,4,12)
    eval(['plot(oo_.irfs.GRDY2_',ShockList{ii},'(1:T)/100/M_.params(find(ismember(param_names,[''sigma'',Shockii]))))'])
    title('Government R&D / GDP')
